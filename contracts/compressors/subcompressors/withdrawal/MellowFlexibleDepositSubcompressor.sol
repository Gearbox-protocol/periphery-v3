...
//         uint256 assetPrice = _getLastAcceptedPrice(mellowRateOracle, token);
...
//         address mellowRateOracle = MellowFlexibleDepositPhantomToken(withdrawalToken).mellowRateOracle();
//         uint256 assetPrice = _getLastAcceptedPrice(mellowRateOracle, depositedAsset);
...
//     function _getLastAcceptedPrice(address mellowRateOracle, address asset) internal view returns (uint256) {
