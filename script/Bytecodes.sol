...
contract Bytecodes {
    ...
    function _getAdapterContracts() internal view returns (Bytecode[] memory bytecodes) {
        ...
        bytecodes[24].contractType = "ADAPTER::INFRARED_VAULT";
        bytecodes[24].version = 3_10;
    ...
    function _getPriceFeedContracts() internal view returns (Bytecode[] memory bytecodes) {
        ...
        bytecodes[7].source = string.concat(oracles, "/contracts/oracles/curve/CurveTWAPPriceFeed.sol");
        ...
        bytecodes[15].contractType = "PRICE_FEED::CONSTANT";
        bytecodes[15].version = 3_10;
